...
import ModalHeader from "../mobile_filter_modal/modal_header";
import FiltersSection from "../mobile_filter_modal/modal_body/filters_section";
...
export default function DesktopFilterSection(props) {
  ...
  return (
    <div className="w-[20vw] px-6 py-8 bg-primary flex flex-col items-center justify-center gap-2 rounded-md shadow-md">
